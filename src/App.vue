<template>
	<v-app>
		...
		>
			<router-link style="text-decoration: none; padding-left: 90px; color: black" to="/"
			...
			<span class="vacancy__field my-auto mr-4">{{role === 'STUDENT'? 'СТУДЕНТ' : role === 'EMPLOYER'? 'КОМПАНИЯ' : 'ЦЕНТР КАРЬЕРЫ'}}</span>
			<v-btn to="/cabinet" icon>
